...
interface ITokenOptions{
    ...
    export const accessTokenExpire = parseInt(process.env.ACCESS_TOKEN_EXPIRY || '300',10)
    export const refreshTokenExpire = parseInt(process.env.REFRESH_TOKEN_EXPIRY || '900',10)
